...
export default Checkout;
          ...
          <p style={styles.secureText}>By clicking "Pay", you agree to our <strong>Terms & Conditions</strong>, <strong>Privacy Policy</strong>, and <strong>Contract of Carriage</strong>. Taxes and fees are nonrefundable.</p>
        </div>
      </div>
    </div>
  );
